...
class MLTrader:
    ...
    def on_trading_iteration(self):
        ...
        profit, _ = self.calculate_profit(predictions, current_prices, next_day_prices)  # Ignore trades
...
if __name__ == "__main__":
    ...
    symbols = ['MAT', 'AAPL', 'GOOG']  # List of symbols for backtesting

    for symbol in symbols:
        strategy = MLTrader(symbol=symbol, starting_cash=starting_cash)
        
        # Define the number of trading iterations (days) you want to simulate
        num_trading_days = 2  # Change this to the desired number of trading days
